...
tf.flags.DEFINE_string('op', 'adam', 'optimizer')
...
tf.flags.DEFINE_integer('f1', 128, 'filter1 size')
...
tf.flags.DEFINE_integer('ib_num', 4, 'num of identity block for residual network')

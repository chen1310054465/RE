...
def init(is_training=True):
    ...
    if 'help' in sys.argv:
        ...
        print('**  --en: (encoder)[cnn pcnn rnn birnn rnn_lstm birnn_lstm rnn_gru birnn_gru rcnn rpcnn]      **')
        print('**                 [bircnn birpcnn rcnn_lstm rpcnn_lstm bircnn_lstm birpcnn_lstm]             **')
